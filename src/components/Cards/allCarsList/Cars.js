...
import MoreStarsCarsCard from './MoreStarsCarsCard';
import LessStarsCarsCard from './LessStarsCarsCard';
...
const Cars = () => {
    ...
    const ActiveView = () => {
        switch (active) {
            ...
            case 3:
                return <MoreStarsCarsCard />; //more stars first

            case 4:
                return <LessStarsCarsCard />; //less stars first
